 ...
 */
angular.module('mean.profile').controller('MyMessageCtrl', function ($scope, MeanUser, PROFILE,$interval,$state) {
    $scope.package = {
        name: 'profile',
        modelName: 'Message'
    };
    initializeBreadCrum($scope, $scope.package.modelName, PROFILE.URL_PATH.PROFILE_MY_PROFILE, "My Message", "Profile Page Description");
    $scope.noImage = true;
    ...
    $scope.noAvatarImg = "/system/assets/img/default-user.png";
    var date = new Date();
    var d = date.getDate();
    var m = date.getMonth();
...
}).controller('ViewMessageCrtl', function ($scope, $stateParams) {
