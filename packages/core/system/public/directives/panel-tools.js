 ...
 */
angular.module('mean.system').directive('ctPaneltool', function () {
    var templates = {
...
angular.module('mean.system').directive('panelExpand', function ($compile) {
    'use strict';
    return {
        restrict: 'A',
        replace: false,
...
angular.module('mean.system').directive('panelRefresh', function () {
    'use strict';
...
angular.module('mean.system').directive('panelDismiss', function () {
    'use strict';
    return {
        restrict: 'A',
        controller: ["$scope", "$element",
