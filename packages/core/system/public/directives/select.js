 ...
 */
angular.module('mean.system').factory('SelectFx', ["$http",
    function ($http) {
        ...
        SelectFx.prototype._initEvents = function (a) {
            ...
            // close the select element if the target itÃ‚Â´s not the select element or one of its descendants..
        ...
        SelectFx.prototype._changeOption = function () {
            ...
            // change native select elementÃ‚Â´s value
...
angular.module('mean.system').directive('csSelect', ["SelectFx", "$timeout",
