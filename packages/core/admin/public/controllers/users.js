...
angular.module('mean.admin').controller('UsersController', ['$scope', 'Global', 'Menus', '$rootScope', '$http', 'Users', 'Circles','UserService',
    function($scope, Global, Menus, $rootScope, $http, Users, Circles,UserService) {
