...
app.route('/api/room/admin/rejectRoom')
 ...
 app.route('/api/adminLogin/getAllRooms')
     .get(roomCtrl.getAllRoomsForAdminLogin);  

 app.route('/api/adminLogin/roomTypeFilter/getRooms')
     .get(roomCtrl.getAllRoomsForAdminLoginByRoomTypeFilter);

  // Api to create schedule for missing days
  app.route('/api/space/room/genricApiToCreateScheduleForMissingSchedule')
     .get(roomCtrl.creatingScheduleThroughApiForMissingSchedule);             
