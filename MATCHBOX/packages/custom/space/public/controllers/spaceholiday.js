...
/* jshint -W098 */
var spaceHolidayModule = angular.module('mean.space');

spaceHolidayModule.controller('SpaceHolidayController',
	function($scope, Global, SpaceHolidayService, HolidaysService, $location,$stateParams, uiCalendarConfig, $filter, $compile, $rootScope, ShareHolidaysService, URLFactory,flash,MESSAGES,DTOptionsBuilder,DTColumnDefBuilder) {
		$scope.global = Global;
		$scope.package = {
			name : 'holidays',
	        modelName: 'Holiday',
