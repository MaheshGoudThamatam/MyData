...
angular.module('mean.search').controller('VirtualOfficeResultController',
	...
	$("#scrollbarContent").mCustomScrollbar({theme:"dark"});
	...
	// Output : SpaceId that the respective room belongs to.
	 ...
	 $scope.cancel = function(){
     	$("#virtualOfficePackageModal").modal('hide');
		};
		
	
		$scope.modal = function(pckgObj){
			$scope.packageObj  = pckgObj
			 $("#virtualOfficePackageModal").modal('show');
